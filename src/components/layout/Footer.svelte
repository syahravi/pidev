  ...
  <div class="container-custom section-padding">
    <div class="grid md:grid-cols-4 gap-8">
      ...
      <div class="md:col-span-2">
        ...
        <p class="mt-4 text-secondary-300 max-w-md">
          {footer.description}
        </p>
        <!-- Social Media -->
      ...
      <div>
        ...
        <ul class="space-y-3">
          {#each footer.quickLinks as link}
            <li>
              <a href={link.href} class="text-secondary-300 hover:text-white transition-colors">
                {link.label}
              </a>
            </li>
          {/each}
    ...
    <!-- Copyright -->
    <div class="mt-12 pt-8 border-t border-secondary-800 text-center text-secondary-400">
