...
<footer class="bg-ink text-white">
  <div class="container-custom section-padding">
      ...
      <div>
        ...
        <ul class="space-y-3 text-white/70">
          <li class="flex items-start">
            <svg class="h-5 w-5 mr-2 mt-0.5 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <li class="flex items-center">
            <svg class="h-5 w-5 mr-2 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <li>
            <a
              href={waTemplates.general}
              target="_blank"
              rel="noopener noreferrer"
              class="inline-flex items-center text-emerald-400 hover:text-green-400 transition-colors"
            >
    ...
    <!-- Copyright -->
    <div class="mt-12 pt-8 border-t border-white/10 text-center text-white/50">
